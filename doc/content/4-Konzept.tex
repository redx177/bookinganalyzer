...
Der Wochenpreis wird aus dem Gesamtpreis der Buchung abgeleitet. Dieser ist für die gesamte Buchungsdauer für alle Passagiere gültig. Der Preis muss demnach durch die Anzahl Tage und Passagiere geteilt und mit "`7"' multipliziert werden.

Zusätzlich müssen für die Wetterdaten die genaue Geolocation des Benutzers vorhanden sein. Im Datenstamm ist die Adresse des Kunden gespeichert, mit welcher die Geolocation ermittelt werden kann. Mittels dieser Geolocation kann das Wetter des Kunden ermittelt werden.
