...
In diesem Abschnitt sind Testfälle definiert welche am Schluss der Entwicklung ausgewertet werden. Dadurch können die Erwartungen an das Programm mit der tatsächlichen Ausgabe des Proof of Concepts verglichen werden.

Definiert werden zwei Arten von Tests. Zum einen sind eigens definierte Datenquellen erstellt worden. Diese bestehen 9 - 18 Einträge wodurch Muster, welche von den Algorithmen erkannt werden sollen, einfach ersichtlich sind. Dadurch kann die Richtigkeit des Programms evaluiert werden.

Zum zweiten wurden Erwartungen definiert, welche in den realen Daten aufgefunden werden sollen. Damit können die verschiedenen Parameter der Algorithmen korrekt eingestellt werden damit das Programm schlussendlich im produktiven Umfeld eingesetzt werden kann.

\subsection{Testdatenquellen}
Es sind 12 Testdatenquellen definiert worden, welche im \cref{app:testdatenquellen} aufgeführt werden. Nachfolgend sind die erwarteten Ausgaben des Programms für die einzelnen Quellen dokumentiert.
