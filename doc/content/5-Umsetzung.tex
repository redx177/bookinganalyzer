...
\begin{figure}[H]
	\RawFloats
	\centering
	\includegraphics[width=1\textwidth]{images/package-diagram}
...
Bei der Dependency Injection handelt es sich um ein \todo{add back in}%\gls{pattern}
...
Für das Dependency Injection \todo{add back in}%\gls{pattern}
