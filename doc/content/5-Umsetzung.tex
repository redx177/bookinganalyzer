...
Um die Analyse durch Algorithmen auf einer Untermenge der Daten durchzuführen (siehe FA3 in \cref{fig:anforderungsanalyse:funktionaleanforderung:fa3}) soll der User die Möglichkeit erhalten durch Einschränkung der Daten diese zu filtrieren. 
...
Dieses Beispiel ist ein Extremfall, da es nur 1'548 Buchungen von 1 Sterne Objekten in der gesamten Datenbasis gibt. Je mehr Buchungen ausfiltriert werden, desto bessere Ergebnisse liefert das Caching.

Wenn die ersten 30 Buchungen in der Buchungen-Einsehen Ansicht angezeigt werden, wird eine Cache-Datei geschrieben welche nur jene Instanzen enthalten, die auf die filterkriterien zupassen. Dazu wird die gesamte Datenbasis durchlaufen und die Kriterien auf jede Buchung anzuwenden. Sobald dies geschehen ist gilt der Cache für diese Kriterien als "`vorgewärmt"'. 
