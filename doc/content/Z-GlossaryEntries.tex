...
\newglossaryentry{gls:gnugpl}{name=GNU General Public License,
	description={GNU GPL ist eine Softwarelizenz, welche es erlaubt den Code auszuführen, zu studieren, zu teilen sowie zu modifizieren. Weitere Informationen unter \url{http://gnu.org/licenses/gpl.html}}
}
