...
Der Hauptfall ist "`Analyse durchführen"' welcher als erstes "`Daten laden"' aufruft. Dort werden alle Einträge in der Datenbasis geladen, wenn vom Benutzer gewünscht gefiltert und zurückgegeben. Zurück bei der Analyse werden anschliessend die Konfigurationen geladen und schlussendlich der Algorithmus angewendet.
...
Der letzte Anwendungsfall ist die Konfiguration der Algorithmen. Dazu werden die einstellbaren Werte dem Benutzer ausgegeben und die Änderungen anschliessend in eine Konfigurationsdatei geschrieben, damit sie bei der nächsten Analyse verwendet werden können.
