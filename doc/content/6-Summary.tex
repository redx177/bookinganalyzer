...
\section{Schlusswort}
Die Apriori Analyse hat sich als hilfreiches Werkzeug für die Attributanalyse der Interhome Buchungsdaten herausgestellt, solange die korrekten Anfragen gestellt werden. Die Clustering Algorithmen konnten hingegen keinen Beitrag zum Ziel dieser Arbeit leisten. Trotzdem wurden durch ihren Einsatz wertvolle Einblicke und ein besseres Verständnis der Datenbasis gewonnen. Für den produktiven Einsatz sollte jedoch die Beischreibung der möglichen Einstellungen im Programm noch verständlicher erläutert werden. 