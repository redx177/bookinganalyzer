...
Die folgenden Methoden geben eine Übersicht über die gängigsten Techniken im Data Mining wider\footcite{top_10_algorithms}. Beschrieben werden Problemstellungen welche mittels Data Mining beantwortet werden. Wie die Auswahl dieser Algorithmen getroffen wurde wird im \cref{sec:konzept:algorithmenauswahl} \nameref{sec:konzept:algorithmenauswahl} erläutert.
